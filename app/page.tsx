...
export default function Home() {
  ...
  useEffect(() => {
    if (showAIPopup) {
      const text =
        "I notice you have some exciting tech sessions today! Would you like me to curate a focus playlist with lo-fi beats and ambient sounds to enhance your productivity during deep work sessions?"
      let i = 0
  ...
  const events = [
    {
      ...
      day: 1,
      description: "Exploring AI integration opportunities",
      location: "Innovation Lab",
      attendees: ["Tech Team", "Product Managers", "Data Scientists"],
      organizer: "CTO",
    },
    {
      id: 2,
      ...
      day: 1,
      description: "Monthly DeFi and NFT portfolio analysis",
      location: "Virtual Meeting",
      attendees: ["Investment Team"],
      organizer: "Portfolio Manager",
    },
    {
      id: 3,
      title: "Metaverse UX Design",
      startTime: "14:00",
      endTime: "15:30",
      color: "bg-gradient-to-r from-pink-500 to-violet-500",
      day: 1,
      description: "VR/AR interface design session",
      location: "Design Studio",
      attendees: ["UX Team", "3D Artists"],
      organizer: "Design Lead",
    },
    {
      id: 4,
      title: "Blockchain Dev Standup",
      startTime: "09:30",
      endTime: "10:00",
      color: "bg-gradient-to-r from-emerald-400 to-teal-500",
      day: 2,
      description: "Smart contract development progress",
      location: "Discord",
      attendees: ["Blockchain Developers"],
      organizer: "Lead Developer",
    },
    {
      id: 5,
      title: "NFT Drop Planning",
      startTime: "13:00",
      endTime: "14:00",
      color: "bg-gradient-to-r from-purple-500 to-pink-500",
      day: 2,
      description: "Next collection strategy and roadmap",
      location: "Creative Space",
      attendees: ["Artists", "Marketing Team"],
      organizer: "Creative Director",
    },
    {
      id: 6,
      title: "Web3 Community Call",
      startTime: "15:00",
      endTime: "16:00",
      color: "bg-gradient-to-r from-indigo-500 to-purple-500",
      day: 3,
      description: "Monthly community engagement session",
      location: "Twitter Spaces",
      attendees: ["Community", "Moderators"],
    ...
    },
    {
      ...
      day: 4,
      description: "Green technology and carbon neutral solutions",
      location: "Convention Center",
      attendees: ["Industry Leaders", "Environmental Team"],
      organizer: "Sustainability Officer",
    },
    {
      id: 8,
      ...
      attendees: ["Research Team", "Engineers"],
      organizer: "Quantum Researcher",
    },
    {
      id: 9,
      ...
      day: 6,
      description: "Supporting digital creators and influencers",
      location: "Co-working Space",
      attendees: ["Creators", "Platform Partners"],
      organizer: "Creator Relations",
    },
    {
      id: 10,
      title: "Space Tech Presentation",
      startTime: "09:00",
      endTime: "10:30",
      color: "bg-gradient-to-r from-slate-400 to-slate-600",
      day: 7,
      description: "Satellite technology and space exploration",
      location: "Auditorium",
      attendees: ["Aerospace Team", "Investors"],
      organizer: "Space Division Lead",
    },
  ]
    ...
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <span className="text-2xl font-semibold text-white drop-shadow-lg">TechFlow Calendar</span>
        </div>
      ...
      <main className="relative h-screen w-full pt-20 flex">
        {/* Sidebar */}
        <div
          className={`w-64 h-full bg-black/20 backdrop-blur-xl p-4 shadow-2xl border-r border-white/10 rounded-tr-3xl opacity-0 ${isLoaded ? "animate-fade-in" : ""} flex flex-col justify-between`}
        ...
        >
          ...
          <div className="flex-1 overflow-auto p-4">
            <div className="bg-black/20 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl h-full">
              {/* Week Header */}
